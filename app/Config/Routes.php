...
$routes->get('/admin', 'admin::TambahWebinar', ['filter' => 'role:admin']);
$routes->get('/admin/formtambahwebinar', 'event::TambahWebinar', ['filter' => 'role:admin']);
$routes->get('/admin', 'admin::EditWebinar', ['filter' => 'role:admin']);
$routes->get('/admin/formeditwebinar', 'admin::EditWebinar', ['filter' => 'role:admin']);
$routes->get('/admin', 'admin::HapusWebinar', ['filter' => 'role:admin']);
$routes->get('/admin/hapuswebinar', 'admin::HapusWebinar', ['filter' => 'role:admin']);
$routes->get('/admin', 'admin::LihatWebinarAdmin', ['filter' => 'role:admin']);
$routes->get('/admin/viewWebinarAdmin', 'admin::LihatWebinarAdmin', ['filter' => 'role:admin']);
$routes->get('/admin', 'event::SimpanWebinar', ['filter' => 'role:admin']);
$routes->get('/admin/inputWebinar', 'event::SimpanWebinar', ['filter' => 'role:admin']);
$routes->get('/', 'peserta::webinarpeserta');
$routes->get('/', 'peserta::lihatwebinar');
